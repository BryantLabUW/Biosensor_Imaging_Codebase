function [] = TCI_PosRamp ()
%% TCI_PosRamp processes YC3.6 calcium responses to a variety of positive thermotaxis ramps
%   [] = TCI_PosRamp()
...
%% Plot Data
if plotlogic > 0
    TCI_Plots_v1(Temps, CaResponse,Stim, UIDs, n, numfiles);
end
...
elseif assaytype == 2
    headers={'UIDs','BelowTh_Spearmans_R', strcat('ResponseSize_',num2str(Stim.Analysis(1)),'C'),strcat('ResponseSize_',num2str(Stim.Analysis(2)),'C')};
    T=table(UIDs',Results.Corr.BelowTh.R', Results.ResponseBin1', Results.ResponseBin2','VariableNames',headers);
end
