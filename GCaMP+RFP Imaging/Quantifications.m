...
%% Quantifications
%   Quantifies simultaneous GCaMP + RFP responses to thermal stimuli. Calculations include:
...
if assaytype ~= 2
    ...
    % When calling ResponseFitting.m, users choose whether to calculate
    ...
    [Results.rsq.AtTh, Results.Corr.AtTh] = ResponseFitting(Temps.AtTh, CaResponse.AtTh,2);
    [Results.rsq.AboveThPear, Results.Corr.AboveThPear] = ResponseFitting(Temps.AboveTh, CaResponse.AboveTh,1);
    [Results.rsq.AboveThSpear, Results.Corr.AboveThSpear] = ResponseFitting(Temps.AboveTh, CaResponse.AboveTh,2);
    [~, Results.Corr_Instant] = ResponseFitting(Temps.subset, CaResponse.subset, 3, Stim);
  ...
  [Results.rsq.Bin1Pear, Results.Corr.Bin1Pear] = ResponseFitting(Temps.AboveThBin1, CaResponse.AboveThBin1,1);
   [Results.rsq.Bin2Pear, Results.Corr.Bin2Pear] = ResponseFitting(Temps.AboveThBin2, CaResponse.AboveThBin2,1);
    ...
    [Results.rsq.BelowTh, Results.Corr.BelowTh] = ResponseFitting(Temps.BelowTh, CaResponse.BelowTh,1,strcat(n,'_BelowTh_'));
