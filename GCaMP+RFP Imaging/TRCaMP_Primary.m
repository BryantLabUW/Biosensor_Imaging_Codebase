function [Temps, CaResponse] = TRCaMP_Primary ()
%% TGRI_Primary processes simultaneous RCaMP + GFP calcium responses to a variety of thermotaxis ramps
...
if isempty(preprocessed) || preprocessed == 0
    ...
    for i=1:numfiles
        ...
        if templost < 1
            ...
            temp.complete(:,1), temp.complete(:,2)]= LoadTrace_RCaMP(filename{i}, fulltemp,Stim, time);
        else
            [temp.full(:,1), temp.full(:,2)] = LoadTrace_RCaMP(filename{i}, [] , Stim, time);
