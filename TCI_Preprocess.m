...
%   [] = TCI_Preprocess()
%   This code translates a .cvs imaging file and .dat temperature recording
%   into a .mat file containing combined imaging and temperature data.
%   Outputs from this process are used as primary inputs to
%   TCI_analyzeEctopic.m analysis code. 
%
%   Version 1.0
